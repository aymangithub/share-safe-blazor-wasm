...
public class MessageService : IService<BasicMessageDto>
{

    public Task<BasicMessageDto> CreateAsync(BasicMessageDto dto)
    {
    ...
    public Task<IEnumerable<BasicMessageDto>> GetAllAsync()
    {
        return Task.FromResult<IEnumerable<BasicMessageDto>>(new List<BasicMessageDto>() {
    ...
    public Task<BasicMessageDto> GetAsync(int id)
    {
        throw new NotImplementedException();
    }

    public Task<BasicMessageDto> UpdateAsync(BasicMessageDto dto)
    {
        throw new NotImplementedException();
    }
}

public class VaultService : IService<VaultDto>
{
